...
This suggests that a reduction of dimensionality is interesting, because some of the variables, being highly correlated with osme others, may not help in giving additional insight into the data.
